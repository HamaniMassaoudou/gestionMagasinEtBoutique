         ...
         <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Gestion des clients</h2>
                </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <section id="fh5co-features">
                    <div class="container">
                        <h3>Formulaire d'enregistrement des clients</h3>
                        <form method="post" action="">
                            <div class="mb-3">
                                <input type="text" class="form-control" name="nomClient" placeholder="Nom client">
                            </div>
                            <div class="mb-3">
                                <input type="text" class="form-control" name="prenomClient" placeholder="Prenom client">
                            </div>
                            <div class="mb-3">
                                <input type="text" class="form-control" name="emailClient" placeholder="Email du client">
                            </div>
                            <div class="mb-3">
                                <input type="int" class="form-control" name="telClient" placeholder="téléphone">
                            </div>
                ...
                <?php
                    if (isset($_POST['nomClient']) && $_POST['nomClient'] != "" ){
                        ...
                        $telClient = trim($_POST['telClient']);
                        $sql="INSERT INTO client (nomClient,prenomClient, emailClient, telClient) 
                        VALUES ('$nomClient','$prenomClient', '$emailClient', $telClient)";
